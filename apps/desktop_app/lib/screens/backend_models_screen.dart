      ...
      body: Consumer<VoiceLabState>(
        builder: (context, state, _) => ListView(
          ...
          children: [
            ...
            _BackendCard(
              title: 'VoxCPM2',
              enabled: state.isVoxCpm2Enabled,
              backendUrl: state.voxCpm2BackendUrl,
              status: state.voxCpm2BackendMessage,
              onEnabledChanged: state.setVoxCpm2Enabled,
              onUrlSubmitted: state.setVoxCpm2BackendUrl,
              onCheckConnection: state.checkVoxCpm2Connection,
            ),
          ],
        ),
      ),
