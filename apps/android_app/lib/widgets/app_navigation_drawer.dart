...
enum AppDestination { home, liveTts, dialog, models, settings, about }
        ...
        child: ListView(
          ...
          children: [
            ...
            _DestinationTile(
              ...
              label: 'Dialog',
              selected: selectedDestination == AppDestination.dialog,
              onTap: () => onDestinationSelected(AppDestination.dialog),
            ),
            _DestinationTile(
            ...
            _DestinationTile(
              ...
              onTap: () => onDestinationSelected(AppDestination.settings),
            ),
            _DestinationTile(
